...
*/    
      ...
      function appendTweet(tweet){
          ...
          $tweet.html(
            ...
            +'<img class="verified" src="muhammad.png" hidden>'+ ' - ' 
...
var nouns = ['cat', 'koolaid', 'system', 'city', 'worm', 'cloud', 'potato', 'money', 'way of life', 'belief system', 'security system', 'bad decision', 'future', 'life', 'pony', 'mind','covfefe'];
